...
const jobSchema = new Schema({
  employerId: { type: Types.ObjectId, ref: "User", required: true, index: true },
  title: { type: String, required: true },
  description: { type: String, required: true },
  location: { type: String, required: true },
  skillsRequired: { type: [String], required: true,  validate: [array => array.length > 0, "At least one skill is required"] },
